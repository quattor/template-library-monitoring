template monitoring/lemon/exception/gridwms;
...
"/system/monitoring/exception/_30109/actuator/active" = true;
...
"/system/monitoring/metric/_5257" = nlist(
        ...
        "param",        list("cmdregex", "/usr/sbin/httpd"),
        "period",       60,
        "smooth",       nlist("typeString", false, "maxdiff", 0.0, "maxtime", 600),
        "active",       true,
        "latestonly",   false,

...
#
template monitoring/lemon/sensor/group_example;

# command line
#    - Note: $modules is mandatory, it will be replaced at ncm configuration time
#      with the correct sensor module names
#
"/system/monitoring/group/example/cmdline" = "/usr/bin/perl /usr/libexec/sensors/lemon-sensor.pl $modules";

...
unique template monitoring/ganglia/rpms/x86_64/host;
...
'/software/packages' = {
  ...
  pkg_repl('ganglia-gmond-modules-python',GANGLIA_VERSION_NUM,'x86_64');
  pkg_repl('ganglia-probes','0.0.1-0.20111026.204343','x86_64');
};
